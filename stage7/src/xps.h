// include guard, prevent multiple inclusions of same header file when compiling
#ifndef XPS_H
#define XPS_H
...
// Data types
typedef unsigned char u_char; // used for data buffers
typedef unsigned int u_int; // used for +ve integer values
typedef unsigned long u_long; // used for +ve integer values
